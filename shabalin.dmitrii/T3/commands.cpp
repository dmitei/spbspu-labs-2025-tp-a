...
namespace
{
  bool isOdd(const shabalin::Polygon & polygon)
  {
    return polygon.points.size() % 2 == 1;
  }

  bool isEven(const shabalin::Polygon & polygon)
  {
    return polygon.points.size() % 2 == 0;
  }

  bool isRightNumber(const shabalin::Polygon & polygon, size_t exp)
  {
    return polygon.points.size() == exp;
  }

  bool isEqPts(const shabalin::Point & point_1, const shabalin::Point & point_2)
  {
    return point_1.x == point_2.x && point_1.y == point_2.y;
  }

  bool isEqualPolygon(const shabalin::Polygon & target, const shabalin::Polygon & seq)
  {
...
double shabalin::calculateTrapezeArea(const Point & point_1, const Point & point_2)
{
  return 0.5 * (point_1.y + point_2.y) * (point_2.x - point_1.x);
}

double shabalin::calculateArea(const Polygon & polygon)
{
...
void shabalin::addIfEven(const std::vector< Polygon > & polygons, std::ostream & out)
{
  using namespace std::placeholders;
...
void shabalin::addIfOdd(const std::vector< Polygon > & polygons, std::ostream & out)
{
  using namespace std::placeholders;
...
void shabalin::mean(const std::vector< Polygon > & polygons, std::ostream & out)
{
  if (polygons.empty())
  {
...
void shabalin::sum(size_t & vrtxs_num, const std::vector< Polygon > & polygons, std::ostream & out)
{
  if (vrtxs_num < 3)
  {
    throw std::logic_error("<INVALID COMMAND>");
...
void shabalin::area(const std::vector< Polygon > & polygons, std::istream & in, std::ostream & out)
{
...
size_t shabalin::getVertexesNum(const Polygon & polygon)
{
  return polygon.points.size();
}

void shabalin::max_area(const std::vector< Polygon > & polygons, std::ostream & out)
{
  if (polygons.empty())
  {
    throw std::logic_error("<INVALID COMMAND>");
...
void shabalin::max_vertexes(const std::vector< Polygon > & polygons, std::ostream & out)
{
  if (polygons.empty())
  {
    throw std::logic_error("<INVALID COMMAND>");
...
void shabalin::max(const std::vector< Polygon > & polygons, std::istream & in, std::ostream & out)
{
  std::map< std::string, std::function< void() > > subcmds;
...
void shabalin::min_area(const std::vector< Polygon > & polygons, std::ostream & out)
{
  if (polygons.empty())
  {
    throw std::logic_error("<INVALID COMMAND>");
...
void shabalin::min_vertexes(const std::vector< Polygon > & polygons, std::ostream & out)
{
  if (polygons.empty())
  {
    throw std::logic_error("<INVALID COMMAND>");
...
void shabalin::min(const std::vector< Polygon > & polygons, std::istream & in, std::ostream & out)
{
  std::map< std::string, std::function< void() > > subcmds;
...
void shabalin::countIfEven(const std::vector< Polygon > & polygons, std::ostream & out)
{
  out << std::count_if(polygons.cbegin(), polygons.cend(), isEven);
}

void shabalin::countIfOdd(const std::vector< Polygon > & polygons, std::ostream & out)
{
  out << std::count_if(polygons.cbegin(), polygons.cend(), isOdd);
}

void shabalin::countIfThisNumber(size_t & num_of_vertexes, const std::vector< Polygon > & polygons, std::ostream & out)
{
...
void shabalin::count(const std::vector< Polygon > & polygons, std::istream & in, std::ostream & out)
{
  std::map< std::string, std::function< void() > > subcmds;
  size_t num_of_vertexes = 0;
  StreamGuard outguard(out);
...
void shabalin::rmecho(std::vector< Polygon > & polygons, std::istream & in, std::ostream & out)
{
  using namespace std::placeholders;
  Polygon polygon;
  if (in >> polygon)
...
void shabalin::maxseq(const std::vector< Polygon > & polygons, std::istream & in, std::ostream & out)
{
  using namespace std::placeholders;
  Polygon polygon;
  if (in >> polygon)
